...
<div class="px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Tambah Jabatan Baru</h2>
        <p class="mt-2 text-lg/8 text-gray-600">Masukkan rincian jabatan baru.</p>
    </div>

    <form action="{{ route('positions.store') }}" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
        @csrf
