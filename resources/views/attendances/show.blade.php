...
<div class="px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Detail Absensi</h2>
        <p class="mt-2 text-lg/8 text-gray-600">Rincian data absensi karyawan.</p>
    </div>
        ...
        <div class="bg-white p-6 sm:p-8 rounded-lg shadow-lg">
            <dl class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                ...
                <div class="sm:col-span-2">
                    <dt class="block text-sm/6 font-semibold text-gray-900">Nama Karyawan</dt>
                ...
                <div>
                    <dt class="block text-sm/6 font-semibold text-gray-900">Tanggal</dt>
                    <dd class="mt-2.5 text-lg font-semibold text-gray-700">
                        {{ \Carbon\Carbon::parse($attendance->tanggal)->format('d F Y') }}
                    </dd>
                </div>

                <div>
                    <dt class="block text-sm/6 font-semibold text-gray-900">Status Absensi</dt>
                    <dd class="mt-2.5 text-lg font-semibold text-gray-700">
                ...
                <div>
                    <dt class="block text-sm/6 font-semibold text-gray-900">Waktu Masuk</dt>
                    <dd class="mt-2.5 text-lg font-semibold text-gray-700">
                ...
                <div>
                    <dt class="block text-sm/6 font-semibold text-gray-900">Waktu Keluar</dt>
                    <dd class="mt-2.5 text-lg font-semibold text-gray-700">
