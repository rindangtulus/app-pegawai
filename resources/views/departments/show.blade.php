...
<div class="px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Detail Departemen</h2>
        <p class="mt-2 text-lg/8 text-gray-600">Rincian data untuk departemen yang dipilih.</p>
    </div>

    <div class="mx-auto mt-16 max-w-xl sm:mt-20">
        <div class="bg-white p-6 sm:p-8 rounded-lg shadow-lg">
            <dl>
                <dt class="block text-sm/6 font-semibold text-gray-900">Nama Departemen</dt>
