...
<div class="px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Edit Departemen</h2>
        <p class="mt-2 text-lg/8 text-gray-600">Perbarui nama departemen.</p>
    </div>

    <form action="{{ route('departments.update', $department->id) }}" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
        @csrf
        @method('PUT')

        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">

            {{-- Field Nama Departemen (dibuat full-width) --}}
            <div class="sm:col-span-2">
                ...
                <div class="mt-2.5">
                    <input id="nama_departemen"
                        ...
                        {{-- Value diisi dengan data $department yang ada --}}
