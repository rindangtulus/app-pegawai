...
<div class="container mt-5 mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 py-6">
    <h1 class="text-2xl font-bold mb-4">Daftar Departemen Rumah Sakit Infor</h1>
    <div class="flex justify-end">

        <a href="/departments/create" class="inline-flex items-center gap-x-2 rounded-lg bg-emerald-800 px-4 py-2 font-semibold text-white transition hover:bg-emerald-900">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('departments.edit', $department->id) }}" class="text-emerald-600 hover:text-emerald-900">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
